...
export default function Footer() {
  return (
    <div style={{display: "flex",flexDirection: "row",justifyContent: "space-evenly",padding: "2.6rem 0",borderRadius: "20px 20px 0 0",position: "fixed",bottom: 0,right: 0,left: 0,zIndex: 1000}} className="footer-color">
      <Link to="/">
